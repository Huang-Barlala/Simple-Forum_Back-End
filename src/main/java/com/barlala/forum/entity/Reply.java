...
public class Reply {
     ...
     * @mbg.generated Fri Jun 26 12:49:18 CST 2020
     */
    public Reply(Integer id, Integer topicid, Integer userid, Date createtime, Date modifytime, Integer serial, String author) {
        this.id = id;
     ...
     * @mbg.generated Fri Jun 26 12:49:18 CST 2020
     */
    public Reply(Integer id, Integer topicid, Integer userid, Date createtime, Date modifytime, Integer serial, String author, String content) {
        this.id = id;
        this.topicid = topicid;
        this.userid = userid;
        this.createtime = createtime;
